...
import { AwsLogDriver, BaseService, CloudMapOptions, Cluster, ContainerDefinition, ContainerImage, ICluster, LogDriver, PropagatedTagSource, Protocol, Secret } from '@aws-cdk/aws-ecs';
 ...
 * @stability stable
 */
export declare abstract class ApplicationMultipleTargetGroupsServiceBase extends CoreConstruct {
    /**
