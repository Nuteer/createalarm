...
RecordTarget[_a] = { fqn: "@aws-cdk/aws-route53.RecordTarget", version: "1.137.0" };
/**
 * A record set.
 *
 * @stability stable
...
RecordSet[_b] = { fqn: "@aws-cdk/aws-route53.RecordSet", version: "1.137.0" };
/**
...
AddressRecordTarget[_c] = { fqn: "@aws-cdk/aws-route53.AddressRecordTarget", version: "1.137.0" };
/**
 * A DNS A record.
 *
 * @stability stable
...
ARecord[_d] = { fqn: "@aws-cdk/aws-route53.ARecord", version: "1.137.0" };
/**
 * A DNS AAAA record.
 *
 * @stability stable
...
AaaaRecord[_e] = { fqn: "@aws-cdk/aws-route53.AaaaRecord", version: "1.137.0" };
/**
 * A DNS CNAME record.
 *
 * @stability stable
...
CnameRecord[_f] = { fqn: "@aws-cdk/aws-route53.CnameRecord", version: "1.137.0" };
/**
 * A DNS TXT record.
 *
 * @stability stable
...
TxtRecord[_g] = { fqn: "@aws-cdk/aws-route53.TxtRecord", version: "1.137.0" };
/**
...
SrvRecord[_h] = { fqn: "@aws-cdk/aws-route53.SrvRecord", version: "1.137.0" };
/**
 * The CAA tag.
 *
 * @stability stable
...
CaaRecord[_j] = { fqn: "@aws-cdk/aws-route53.CaaRecord", version: "1.137.0" };
/**
...
CaaAmazonRecord[_k] = { fqn: "@aws-cdk/aws-route53.CaaAmazonRecord", version: "1.137.0" };
/**
 * A DNS MX record.
 *
 * @stability stable
...
MxRecord[_l] = { fqn: "@aws-cdk/aws-route53.MxRecord", version: "1.137.0" };
/**
 * A DNS NS record.
 *
 * @stability stable
...
NsRecord[_m] = { fqn: "@aws-cdk/aws-route53.NsRecord", version: "1.137.0" };
/**
 * A DNS DS record.
 *
 * @stability stable
...
DsRecord[_o] = { fqn: "@aws-cdk/aws-route53.DsRecord", version: "1.137.0" };
/**
...
ZoneDelegationRecord[_p] = { fqn: "@aws-cdk/aws-route53.ZoneDelegationRecord", version: "1.137.0" };
/**
...
CrossAccountZoneDelegationRecord[_q] = { fqn: "@aws-cdk/aws-route53.CrossAccountZoneDelegationRecord", version: "1.137.0" };
