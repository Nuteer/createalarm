...
/**
 * Properties for defining a `AWS::EC2::IPAM`.
 *
 * @external
...
export declare namespace CfnIPAM {
    ...
    interface IpamOperatingRegionProperty {
        /**
         * `CfnIPAM.IpamOperatingRegionProperty.RegionName`.
         *
         * @external
...
/**
 * Properties for defining a `AWS::EC2::IPAMAllocation`.
 *
 * @external
...
/**
 * Properties for defining a `AWS::EC2::IPAMScope`.
 *
 * @external
...
export declare class CfnIPAMScope extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-ipamscope.html#cfn-ec2-ipamscope-ipamscopetype
     */
    ipamScopeType: string | undefined;
    /**
     * `AWS::EC2::IPAMScope.Tags`.
     *
     * @external
